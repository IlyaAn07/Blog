                ...
                foreach($articles as $article): ?>
                    <article class="post">
                        <div class="post-thumb">
                            <a href="<?= Url::toRoute(['site/view', 'id' => $article->id]) ?>"><img src="<?php echo $article->getImage(); ?>" alt=""></a>
                        ...
                        <div class="post-content">
                            <header class="entry-header text-center text-uppercase">
                                <h5><a href="<?= Url::toRoute(['site/category', 'id' => $article->category->id]) ?>"><?= $article->category->title; ?></a></h5>
                            ...
                            <div class="social-share">
                                ...
                                <ul class="text-center pull-right">
                                    <li><a class="s-facebook" href="<?= Url::toRoute(['', 'id' => $article->id]) ?>"><i class="fa fa-eye"></i></a></li><?= (int)$article->viewed ?>
                                </ul>
                            </div>
                        </div>
                    </article>
